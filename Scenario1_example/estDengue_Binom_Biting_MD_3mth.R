...
## Miami-Dade medium R0: V->H and H->V transmission with species-specific lambda; , 3-month lasting immunity
...
guesses <- sobol_design(
  ...
  upper=c(a=1, 
          ...
          rhoT=0.3),
  nseq=NSEQ) |> 
  mutate(gamma = 30.5/(3*30.5), mu = 1027/(12*100000), br = 11/(12*1000))
...
# 0.179 0.250 0.281 0.333 0.000856 0.000917 # y.out 3 mths
