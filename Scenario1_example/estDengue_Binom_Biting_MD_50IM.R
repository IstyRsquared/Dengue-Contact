...
## Miami-Dade medium R0: V->H and H->V transmission with species-specific lambda (Scenario 1), 50% immunity
...
rproc <- Csnippet("
                  ...
                  double lambdaH = a * c * 1/(mum) * M * (((S - deathsS)*0.5)/pop);  
